var main = function (input) {
  ...
  if (
    ...
    return `The computer chose ${comp}.<br>
            You chose ${input}.<br><br>
            ${result}<br><br>
            Now you can type "scissors" "paper" or "stone" to play another round, or reverse it by adding the word "reversed" to your choice!`;
  }
  return `Try again. <br>
          Now you can type "scissors" "paper" or "stone" to play another round, or reverse it by adding the word "reversed" to your choice!`;
};
