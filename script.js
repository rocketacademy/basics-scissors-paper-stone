...
var main = function (input) { 
  ...
  if (playerwins(playerSPS, computerSPS)){
    return showplayercomputerSPS + "you entered "+ playerSPS + ", the computer has " + computerSPS + ". you win";
  }

  if (draw (playerSPS, computerSPS)){
    return showplayercomputerSPS + "you entered "+ playerSPS + ", the computer has " + computerSPS + ". it's a draw";
  }
...
var showplayercomputerSPS = function (playerSPS, computerSPS) {
  ...
  return (
    showplayercomputerSPS + "you entered "+ playerSPS + ", the computer has " + computerSPS + ". you lost";
  );
};