...
var main = function (userInput) {
  ...
  // If game mode is "Game Introduction", inform user to start playing by entering either one of the 6 options
  ...
  if (userInput == "reverse") {
    ...
    if (reverseCount == 0 || reverseCount % 2 == 1) {
      ...
      myOutputValue = `Hey ${userName}! You have entered the reversed game mode.<br ><br >Submit "scissors", "paper" or "stone" to start playing!<br ><br >You can also submit "reverse" to reverse the game rules.`;
      return myOutputValue;
    } else {
      gameMode = "Original Mode";
      // console.log(`The current game mode is ${gameMode}.`);
      myOutputValue = `Hey ${userName}! You have entered the original game mode.<br ><br >Submit "scissors", "paper", "stone", "reversed scissors", "reversed paper" or "reversed stone" to start playing!<br ><br >You can also submit "reverse" to reverse the game rules.`;
      return myOutputValue;
    }
  }
...
// ===== Function to check user input against program output to determine winner =====
...
var generateWinner = function (userInput) {
  ...
  if (gameMode == "Original Mode") {
    myOutputValue = originalRules(userInput, outputByProgram);
  } else if (gameMode == "Reversed Mode") {
    myOutputValue = reversedRules(userInput, outputByProgram);
  }
  return myOutputValue;
};

// ===== Function to determine winner with original rules =====

var originalRules = function (userInput, outputByProgram) {
...
// ===== Function to determine winner with reversed rules =====

var reversedRules = function (userInput, outputByProgram) {
  var choiceStatement = `Hey ${userName}, you chose ${userInput} and the computer chose ${outputByProgram}.`;
